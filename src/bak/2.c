...
#include <X11/extensions/XShm.h> // Added for XShmQueryExtension
#include <Imlib2.h>
#include <unistd.h> // For sleep()

#define ConnectionDisconnected 1
#define PATHS {"pics/1.png", "pics/2.png", "pics/3.png", "pics/4.png", "pics/5.png", "pics/6.png"}
#define WALLPAPER_CHANGE_INTERVAL 1 // Seconds between wallpaper changes
...
int main(int argc, char **argv) {
        ...
        char *paths[] = PATHS;
        size_t num_paths = sizeof(paths) / sizeof(*paths);
